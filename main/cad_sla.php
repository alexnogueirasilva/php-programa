			...
			<div class="white-box">
				...
				<table id="tabela" class="table table-striped">
					...
					<tbody>
						...
						<?php
						$dados = crud::mostraSla($idInstituicao);
						...
						if ($dados->rowCount() > 0) {
							while ($row = $dados->fetch(PDO::FETCH_ASSOC)) {
								...
								<tr>
									...
									<td><a class="btn btn-info waves-effect waves-light" data-toggle="modal" data-target="#modalEditSla" data-whatever="@getbootstrap" id="btnEditar" class="btn btn-danger waves-effect waves-light" data-codigo="<?php print($row['id']); ?>" data-desc="<?php print($row['descricao']); ?>" data-tempo="<?php print($row['tempo']); ?>" data-idinstituicao="<?php print($row['fk_idInstituicao']); ?>" data-unitempo="<?php print($row['unitempo']); ?>">Editar</a></td>

									<td><a class="btn btn-danger waves-effect waves-light" data-toggle="modal" data-target="#modalDeleteSla" data-whatever="@getbootstrap" id="btnExcluir" class="btn btn-info waves-effect waves-light" data-idinstituicao="<?php print($row['fk_idInstituicao']); ?>" data-codigo="<?php print($row['id']); ?>" data-desc="<?php print($row['descricao']); ?>">Excluir</a></td>
								</tr>
							<?php
						}
					} else {
