						...
						$dados = StatusDAO::listar();
							...
							while($row=$dados->fetch(PDO::FETCH_ASSOC)){
								...
								<tr>
									...
									<td><a class="btn btn-info waves-effect waves-light" data-toggle="modal" 
									data-target="#modalEditarStatus" data-whatever="@getbootstrap" id="btnEditar" class="btn btn-danger waves-effect waves-light" 
										data-codigo="<?php print($row['codStatus']); ?>" 
										data-datacadastro="<?php print(crud::formataData($row['dataCadastro'])); ?>"
										data-descricao="<?php print($row['nome']); ?>" >Editar</a></td>									
									
										<td><a class="btn btn-danger waves-effect waves-light" data-toggle="modal"  data-target="#modalDeleteStatus" 
									data-whatever="@getbootstrap" id="btnExcluir" class="btn btn-info waves-effect waves-light" 
									data-codigo="<?php print($row['codStatus']); ?>" data-descricao="<?php print($row['nome']); ?>">Excluir</a></td>         
								</tr>
								<?php 
							}
