		...
		<h3 class="panel-title text-center">INFORMACOES DE PEDIDOS</h3><br>
			<div class="col-sm-3 text-center">
				<div class="panel panel-info">
					...
					<div class="panel-body" onclick="window.location.href = 'pedidoMunicipio.php'" style="cursor:pointer">
			...
			<div class="col-sm-3 text-center">
				<div class="panel panel-success">
					...
					<div class="panel-body" onclick="window.location.href = 'pedidoAtendidoMunicipio.php'" style="cursor:pointer">
			...
			<div class="col-sm-3 text-center">
				<div class="panel panel-danger">
					...
					<div class="panel-body" onclick="window.location.href = 'pedidoCanceladoMunicipio.php'" style="cursor:pointer">
			...
			<div class="col-sm-3 text-center">
				<div class="panel panel-yellow">
					...
					<div class="panel-body" onclick="window.location.href = 'pedidoPendenteMunicipio.php'" style="cursor:pointer">
					...
					<div class="panel-body">
						<table class="table table-hover">
							...
							<tbody>
								<tr>
									<td>
										<a href="pedidoMunicipio.php"><?php print($arrayAndre[0]['nomeCliente']); ?></a>
									</td>
									<td>
										<a href="pedidoMunicipio.php"><a href="#"><?php print($arrayAndre[0]['qtdePedidos']); ?></a></a>
									</td>
									<td class="hidden-xs">
								...
								<tr>
									<td>
										<a href="pedidoMunicipio.php"><a href="#"><?php print($arrayAndre[2]['nomeCliente']); ?></a></a>
									</td>
									<td>
										<a href="pedidoMunicipio.php"><a href="#"><?php print($arrayAndre[2]['qtdePedidos']); ?></a></a>
									</td>
									<td class="hidden-xs">
										<a class="btn btn-xs btn-info" href="#">Detalhes</a>
									</td>
								...
								<tr>
									<td>
										<a href="pedidoMunicipio.php"><?php print($arrayAndre[4]['nomeCliente']); ?></a>
									</td>
									<td>
										<a href="pedidoMunicipio.php"> <?php print($arrayAndre[4]['qtdePedidos']); ?></a>
									</td>
									<td class="hidden-xs">
										<a class="btn btn-xs btn-info" href="#">Detalhes</a>
									</td>
